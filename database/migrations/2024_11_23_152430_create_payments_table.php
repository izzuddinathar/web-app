...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('payments', function (Blueprint $table) {
            ...
            $table->enum('metode_pembayaran', ['tunai', 'kartu kredit', 'kartu debit', 'qris']); // Payment Method
            $table->enum('status', ['belum dibayar', 'lunas'])->default('belum dibayar'); // Payment Status
